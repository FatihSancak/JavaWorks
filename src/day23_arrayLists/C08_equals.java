...
public class C08_equals {
    public static void main(String[] args) {
        ...
        /*
        *  ürünlerin sýralamalarý farklý olduðundan sonuc FALSE döner
        *  ancak her iki listede öncelikle sýralanýr sonra
        *  equals method'u çalýþtýrýlýrsa sonuç TRUE döner
        */

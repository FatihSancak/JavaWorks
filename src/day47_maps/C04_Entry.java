package src.day47_maps;

import src.day46_maps.ReusableMethods;
...
public class C04_Entry {
    public static void main(String[] args) {
        ...
        /*
        Java Entry<K,V> map'in icerisinde bulunan herbir kaydi
        K=V seklinde tutar
        dolayisiyla herhangi bir Entry'e ulastigimizda
        hem key'e hem de value'ya ulasabilir ve istedigimiz
        islemleri yapabiliriz
        entry.getKey() bize key'i getirir
        entry.getValue() bize value'yu getirir
        entry.setValue'yu istedigimiz deger olarak update eder
         */
